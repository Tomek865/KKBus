...
export default function DriverDashboard() {
    return (
        // Zmieniliśmy główny View na ScrollView, żeby można było przewijać ekran na telefonie
        <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
            ...
            {/* ZMIANA TUTAJ: Elementy układają się w kolumnę na wąskich ekranach */}
            <View style={styles.contentColumn}>

                {/* Sekcja: Skanowanie Biletu (Dajemy to wyżej, bo to najważniejsza akcja dla kierowcy na telefonie) */}
...
const styles = StyleSheet.create({
    ...
    // Zmieniliśmy układ na kolumnowy
